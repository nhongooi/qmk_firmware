...
//prob want a third layer and stack up lower for more useful keys
  ...
  [_LOWER] = LAYOUT(
    ...
    TG(_FACTORIO),     _______,    _______,    _______,    _______,       _______,                   _______, _______, _______, _______, TG(_FACTORIO), TG(_MEDIA),
  ...
  [_MEDIA] = LAYOUT(
    ...
    _______, _______, _______, _______, _______, _______,  _______, KC_PAUS,  KC_LT,        KC_GT,         _______, _______,       _______, TG(_MEDIA),
                               _______, _______, _______,  _______, _______,  _______,      _______,       _______),
  [_IDEA] = LAYOUT(
  ...
  [_FACTORIO] = LAYOUT(
    ...
    KC_LSFT, KC_Z,    _______,  _______,       _______, _______,   _______, _______, _______, _______, _______, _______,  _______, _______,
                                TG(_FACTORIO), KC_LALT, KC_LCTRL,  _______, _______, _______, _______, _______)
