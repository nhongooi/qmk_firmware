...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT(
     ...
     GUIDEL,    KC_A,   KC_S,    KC_D,    KC_F,       KC_G,          KC_H,     KC_J,     KC_K,    KC_L,    KC_SCLN, KC_ENT,
     KC_LSFT,   ALTZ,   KC_X,    KC_C,    KC_V,       KC_B,          KC_N,     KC_M,     KC_COMM, KC_DOT,  KC_SLSH, MOUSE,
                                          LOWERBR,    KC_SPC,        _______,  RAISEBR
  ),
  [_LOWER] = LAYOUT(
