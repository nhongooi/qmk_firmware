...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT(
    ...
    LSHZ, KC_X,    KC_C,    KC_V,    KC_B,            KC_N,    KC_M,  KC_COMM, KC_DOT, RLSH,
                            KC_LGUI, SPM1,            BSM2,    ALTTAB
  ),
  [_LOWER] = LAYOUT(
    KC_1,     KC_2,   KC_3,   KC_4,    KC_5,            KC_6,     KC_7,     KC_8,      KC_9,    KC_0,
    MOVEL,    MOVED,  MOVEU,  MOVER,   KC_ENT,          KC_QUOT,  KC_MINS,  KC_EQL,    _______, _______,
    _______,  WORK1,  WORK2,  WORK3,   WORK4,           KC_GRAVE, KC_PLUS,  _______,   _______, _______,
                            _______, _______,           _______, _______
  ),
  [_RAISE] = LAYOUT(
     _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,           KC_HOME,  KC_PGUP,  KC_ENT,   _______,  KC_ESC,
    _______,  KC_F5,   KC_F6,   KC_F7,   KC_F8,           KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT,  KC_PIPE,
    _______,  KC_F9,   KC_F10,  KC_F11,  KC_F12,          KC_END,   KC_PGDN,  KC_DEL,   KC_LBRC,  KC_RBRC,
                                _______, KC_ENT,          _______,  _______
  ),
    [_RPG] = LAYOUT(
    _______, _______, _______, _______,  _______,        _______,  KC_X,     KC_UP,    KC_S,     _______,
    _______, _______, _______, _______,  _______,        _______,  KC_LEFT,  KC_DOWN,  KC_RGHT,  KC_Z,
    _______, _______, _______, _______,  _______,        _______,  _______,  _______,  _______,  KC_RSFT,
                               _______,  _______,        KC_ENT,  RPG
  ),
  [_MEDIA] = LAYOUT(
